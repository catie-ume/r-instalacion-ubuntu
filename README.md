...
El procedimiento que se describe a continuación está basado en el tutorial [How To Install R on Ubuntu 16.04 | Digital Ocean](https://www.digitalocean.com/community/tutorials/how-to-install-r-on-ubuntu-16-04-2). Instala la versión más reciente que esté disponible en los repositorios de R. Debe ser ejecutado por un usuario con derechos de ```sudo```.
